...
%V_ROTRO2QR converts a 3x3 v_rotation matrix to a real quaternion
% Inputs:
%
...
mm=d>1; % mask for v_rotation angles < 120 degrees
if any(mm)                       % for v_rotation angles less than 120 degrees
