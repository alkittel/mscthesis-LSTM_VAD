...
%V_CORRELOGRAM calculate v_correlogram [y,ty]=(x,inc,nw,nlag,m,fs)
% Usage:
...
%
% Inputs:
%        x(*,chan)  is the output of a v_filterbank (e.g. v_filterbank)
...
% [2]	S. Granqvist and B. Hammarberg. The v_correlogram: a visual display of periodicity. J. Acoust. Soc. Amer., 114: 2934, 2003.
